...
These are super important courses full of foundational knowledge. Your goal at the end of these should be to confidently explain how to reverse a linked list or how to implement a hash table. Afterwards, advanced concepts will be much, much easier to grasp if you thoroughly understand the simpler concepts. The simpler concepts more or less comprises the lion’s share of what’s asked in technical interviews anyway. There’s a ton of resources to fall back on if you’re struggling in these, too, especially [Code Red](https://spec.cs.rutgers.edu/spaces/the-csl/). In general, good grades will come naturally if you invest time and energy into truly understanding and engaging with the course material. CS 111 and CS 112 give you a ton of time to do assignments and the community is literally designed to support you academically.
...
If you're thinking about completing the CS degree in 2 or 3 years, you need to start planning for credit-intensive semesters starting freshman or sophomore year.
...
One of the main draws of the iLab Assistant position at the CSL is that it helps you become a natural communicator which makes it easier to do well in interviews. As an interviewer, it’s pretty clear when someone can communicate their ideas effectively and when they can’t.
...
Also, most undergraduate electives have a graduate equivalent, and the graduate equivalent counts for the undergraduate course. For example, many students opt to take [Graduate Algorithms I](https://tinyurl.com/algos-grad) instead of [Algorithms](https://tinyurl.com/algos-undergrad). I opted to take both of them and found that Undergrad Algo covered a great breadth of topics and Grad Algo covered topics in more depth.
...
* [Course Snipe](https://www.schedru.me/) the sections that work for your schedule (thanks V and Abe Stanway for this).
